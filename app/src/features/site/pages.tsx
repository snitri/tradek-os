    ...
    <div>
      ...
      <section className="sec-pad" style={{ maxWidth: 1100, margin: "0 auto", padding: "56px 40px 0" }}>
        ...
        <div className="g-2m" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 1, background: "var(--line)", border: "1px solid var(--line)", borderRadius: 6, overflow: "hidden", marginTop: 28 }}>
          {([["Análise", "Solicite a análise do crédito por um de nossos canais"], ["Crédito na origem", "Banco/seguradora define a linha de crédito disponível."], ["Pagamento", "Pagamos seu fornecedor direto na Ásia."], ["Prazo", "Você quita em 90–180 dias, conforme aprovado."]] as [string, string][]).map(([t, d], i) =>
