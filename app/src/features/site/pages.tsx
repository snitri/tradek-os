  ...
  return (
    <div>
      <section style={{ position: "relative", overflow: "hidden", borderBottom: "1px solid var(--line)" }}>
        ...
        <div className="g-1m sec-pad" style={{ position: "relative", maxWidth: 1280, margin: "0 auto", padding: "28px 40px 60px", display: "grid", gridTemplateColumns: "1.15fr .85fr", gap: 48, alignItems: "start" }}>
          <div className="fade">
