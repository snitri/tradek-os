    ...
    <div>
      ...
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "56px 40px 0" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 1, background: "var(--line)", border: "1px solid var(--line)", borderRadius: 6, overflow: "hidden", marginTop: 28 }}>
          {([["Análise", "Avaliamos cadastro, documentos e a operação de importação."], ["Aprovação", "Banco/seguradora define a linha de crédito disponível."], ["Pagamento", "Pagamos seu fornecedor direto na Ásia."], ["Prazo", "Você quita em 90–180 dias, conforme aprovado."]] as [string, string][]).map(([t, d], i) =>
...
export function SiteProc() {
  return (
    <div>
      <UnitHero u="PROC" cta="Iniciar um briefing" title="Encontramos, validamos e negociamos seu fornecedor." sub="Sourcing internacional sob medida: da busca à inspeção. Você define o produto e o orçamento-alvo; cuidamos da curadoria de fornecedores chineses." />
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "56px 40px 0" }}>
...
export function SiteFAQ() {
  ...
  return (
    <div style={{ maxWidth: 880, margin: "0 auto", padding: "64px 40px 0" }}>
...
export function SiteContato() {
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "64px 40px 0", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48 }}>
      <div>
...
export function SiteObrigado() {
  return (
    <div style={{ maxWidth: 680, margin: "0 auto", padding: "90px 40px", textAlign: "center" }}>
